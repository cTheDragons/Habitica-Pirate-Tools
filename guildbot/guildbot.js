...
function reportResults(){
    ...
    function exportStats(){
        ...
        if (gConfig.debug) consoleLogToFile('*********************  Complete Stat Stat   *********************')
    ...
    function exportMasterList(){
        ...
        if (gConfig.debug) consoleLogToFile('*********************  Complete Master Stat   *********************')
    ...
    function exportPirateAction(){
					...
					if (droppedAnchor){
						...
						switch (obj.idList){
							...
							case logListIdDoNotHail: 
								...
								break;
							case logListIdBermudaTriangle: 
									tempBox.guilds.bermudaTriangle.push( {id: obj.name, name: nameToShow, url: gConfig.habiticaGuildUrl + obj.name, return: obj.due })
								break;
							default:
		...
		if (gConfig.debug) consoleLogToFile('*********************  Complete Pirate Stat   *********************')
